...
"""
    ...
    # Add technologies
    if summary.get('technologies', {}).get('items'):
        html += """
        <div class="section">
            <h2>💻 Detected Technologies</h2>
            <div style="display: flex; flex-wrap: wrap; gap: 10px;">
"""
        for tech in summary['technologies']['items'][:20]:
            html += f"""
                <span style="background: #667eea; color: white; padding: 5px 15px; border-radius: 20px; font-size: 0.9em;">{tech}</span>
"""
        html += """
            </div>
        </div>
"""
    ...
    html += """
        <footer>
            <p>Generated by Vṛthā WordPress VAPT Framework</p>
